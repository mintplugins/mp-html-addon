 ...
 */
 if (!function_exists('mp_core_plugin_check')){
	function mp_core_plugin_check() {
		$args = array(
			'plugin_name' => __('Move Plugins Core', 'mp_html_in_post_addon'), 
			'plugin_message' => __('You require the Move Plugins Core plugin. Install it here.', 'mp_html_in_post_addon'), 
			'plugin_slug' => 'mp_core', 
